        ...
        <div className="flex flex-col items-center">
          {links.map((items, i) => (
            <div
              className={
                items.title === "Profile" || items.title === "Admin Profile"
                  ? "rounded hover:cursor-pointer border border-blue-500 px-3 py-1 my-3 hover:bg-white hover:text-zinc-900 transition-all duration-300"
                  : "mx-3 hover:text-blue-300 rounded transition-all duration-300 hover:cursor-pointer my-3"
              }
              key={i}
            >
              <Link
